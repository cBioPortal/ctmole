/**
 * Created by jiaojiao on 3/10/16.
 */
'use strict';
/*
...
var Trial = require('../../app/models/trial.server.model'),
    Cancertype = require('../../app/models/cancertypes.server.model');

module.exports = {
    addtrialsByMutationCancerGET: addtrialsByMutationCancerGET,
    addtrialsByMutationCancerPOST: addtrialsByMutationCancerPOST
};


function addtrialsByMutationCancerGET(req, res) {
...
function addtrialsByMutationCancerPOST(req, res) {
